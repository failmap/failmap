...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(default='', help_text='Text that helps explain why this result is not counted in the report. For example: a broken scanner or another edge-case that is mainly on the side of the scanning party. Having requested the supplier for a fix, or promising a fix should be stored as a promise, not as an explanation.', max_length=255, verbose_name='explanation'),
        ),
        migrations.AddField(
            model_name='endpointgenericscan',

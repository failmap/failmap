    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(help_text='An internet address, including the http/https scheme. Works only on IP. Username / pass can beadded in the address. For example: https://username:password@192.168.1.1:1337/', max_length=255)),
                ('currently_used_in_tls_qualys_scan', models.BooleanField(default=False,
                ...
                ('out_of_resource_counter', models.IntegerField(
                    default=0, help_text='Every time the proxy has not enough resources, this number will increase with one. A too high number makes it easy not to use this proxy anymore.')),
            ],
        ),
    ]

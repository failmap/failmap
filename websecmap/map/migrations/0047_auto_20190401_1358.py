    ...
    state_operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('high_endpoints', models.IntegerField(default=0, help_text='Amount of endpoints with (1 or more) high risk issues.')),
                ('medium_endpoints', models.IntegerField(default=0, help_text='Amount of endpoints with (1 or more) medium risk issues.')),
                ...
                ('endpoint_issues_medium', models.IntegerField(default=0, help_text='Total amount of issues on endpoint level.')),
                ...
                ('explained_total_issues', models.IntegerField(default=0, help_text='The summed number of all vulnerabilities and failures.')),
                ('explained_high', models.IntegerField(default=0, help_text='The number of high risk vulnerabilities and failures.')),
                ('explained_medium', models.IntegerField(default=0, help_text='The number of medium risk vulnerabilities and failures.')),
                ...
                ('explained_high_urls', models.IntegerField(default=0, help_text='Amount of urls with (1 or more) high risk issues.')),
                ('explained_medium_urls', models.IntegerField(default=0, help_text='Amount of urls with (1 or more) medium risk issues.')),
                ('explained_low_urls', models.IntegerField(default=0, help_text='Amount of urls with (1 or more) low risk issues.')),
                ('explained_total_endpoints', models.IntegerField(default=0, help_text='Amount of endpoints for this url.')),
                ('explained_high_endpoints', models.IntegerField(default=0, help_text='Amount of endpoints with (1 or more) high risk issues.')),
                ('explained_medium_endpoints', models.IntegerField(default=0, help_text='Amount of endpoints with (1 or more) medium risk issues.')),
                ('explained_low_endpoints', models.IntegerField(default=0, help_text='Amount of endpoints with (1 or more) low risk issues.')),
                ('explained_total_url_issues', models.IntegerField(default=0, help_text='Total amount of issues on url level.')),
                ('explained_url_issues_high', models.IntegerField(default=0, help_text='Number of high issues on url level.')),
                ('explained_url_issues_medium', models.IntegerField(default=0, help_text='Number of medium issues on url level.')),
                ('explained_url_issues_low', models.IntegerField(default=0, help_text='Number of low issues on url level.')),
                ('explained_total_endpoint_issues', models.IntegerField(default=0, help_text='Total amount of issues on endpoint level.')),
                ('explained_endpoint_issues_high', models.IntegerField(default=0, help_text='Total amount of issues on endpoint level.')),
                ('explained_endpoint_issues_medium', models.IntegerField(default=0, help_text='Total amount of issues on endpoint level.')),
                ('explained_endpoint_issues_low', models.IntegerField(default=0, help_text='Total amount of issues on endpoint level.')),
                ('when', models.DateTimeField(db_index=True)),
                ('calculation', jsonfield.fields.JSONField(help_text='Contains JSON with a calculation of all scanners at this moment, for all urls of this organization. This can be a lot.')),

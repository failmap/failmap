...
// modified to not expect $ for jQuery and removed image bits.
...
jQuery.fn.sparkleh = function( options ) {
  ...
  return this.each( function(k,v) {
    ...
    var $this = jQuery(v).css("position","relative");
...
Sparkle.prototype = {
  ...
  "createSparkles" : function( w , h ) {
    ...
    for( var i = 0; i < this.options.count; i++ ) {
      ...
      } else if( jQuery.type(this.options.color) === "array" ) {

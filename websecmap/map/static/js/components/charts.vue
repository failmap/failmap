        ...
        messages: {
            en: {
                charts: {
                    ...
                    top_fail:{
                        title: "Organizations with the most issues",
                    },
                    top_win: {
                        title: "Organizations with very few to zero issues",
                    }
                }
            },
            nl: {
                charts: {
                    title: "De beste en slechtste",
                    top_fail:{
                        title: "Organisaties met de meeste risico's",
                    },
                    top_win: {
                        title: "Organisaties met de minste tot geen risico",
                    }
                }
            }
        },

        ...
        <a class="navbar-brand" href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item" v-if="config.show.intro"><a class="nav-link" href="#info">
                    ...
                    <li class="nav-item" v-if="config.show.charts"><a class="nav-link" href="#charts">
                    ...
                    <li class="nav-item" v-if="config.show.statistics"><a class="nav-link" href="#extensive_statistics">
                        ...
                        {{ $t("menu.statistics") }}</a></li>

                    <li class="nav-item" v-if="config.show.comply_or_explain"><a class="nav-link" href="#comply_or_explain_info">
                        ...
                        {{ $t("menu.comply_or_explain") }}</a></li>

                    <li class="nav-item" v-if="config.show.scan_schedule"><a class="nav-link" href="#schedule">
                        ...
                        {{ $t("menu.scan_schedule") }}</a></li>

                    <li class="nav-item" v-if="config.show.datasets"><a class="nav-link" href="#datasets">

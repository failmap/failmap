...
from websecmap.scanners.scanner import (dns_clean_wildcards, dnssec, dummy, ftp,
                                        internet_nl_v2_mail, internet_nl_v2_web, onboard,
                                        plain_http, screenshot, security_headers, tls_qualys)

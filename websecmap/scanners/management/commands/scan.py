...
from websecmap.scanners.scanner import (dnssec, dummy, ftp, internet_nl_mail, internet_nl_v2_mail,
                                        internet_nl_v2_web, internet_nl_web, onboard, plain_http,

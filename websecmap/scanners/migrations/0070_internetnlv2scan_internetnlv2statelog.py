    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scan_id', models.CharField(blank=True, help_text='The scan ID that is used to request status and report information.', max_length=32, null=True)),
                ('state', models.CharField(blank=True, help_text='where the scan is: registered, scanning, creating_report, finished, failed', max_length=200, null=True)),
                ('state_message', models.CharField(blank=True, help_text='Information about the status, for example error information.', max_length=200, null=True)),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scanner', models.CharField(db_index=True, default='', help_text='tlsq, dnssec, http_security_headers, plain_http, internet_nl_mail, dnssec, ftp, dns_endpoints', max_length=10)),
                ('state', models.CharField(db_index=True, default='', help_text='requested, picked_up, finished, error, timeout', max_length=10)),

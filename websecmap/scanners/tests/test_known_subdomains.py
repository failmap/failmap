...
def test_get_subdomains(db):
    ...
    assert (
        ...
        f"| {wspf}('discover', 'known_subdomains', <Url: test.ex.com>), "
        f"{wasssw}([<Url: example.ex.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: example.ex.com>), "
        f"{wasssw}([<Url: first.ex.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: first.ex.com>), "
        f"{wasssw}([<Url: second.ex.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: second.ex.com>), "
        f"{wasssw}([<Url: test.mydomain.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: test.mydomain.com>), "
        f"{wasssw}([<Url: example.mydomain.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: example.mydomain.com>), "
        f"{wasssw}([<Url: first.mydomain.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: first.mydomain.com>), "
        f"{wasssw}([<Url: second.mydomain.com>], ['example', 'first', 'second', 'test']) "
        f"| {wspf}('discover', 'known_subdomains', <Url: second.mydomain.com>)])"
    )

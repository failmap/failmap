...
class Migration(migrations.Migration):
    ...
    state_operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('explained_endpoint_issues_low', models.IntegerField(
                    default=0, help_text='Total amount of issues on endpoint level.')),
                ('when', models.DateTimeField(db_index=True)),
                ('calculation', jsonfield.fields.JSONField(help_text='Contains JSON with a calculation of all scanners at this moment. The rating can be spread out over multiple endpoints, which might look a bit confusing. Yet it is perfectly possible as some urls change their IP every five minutes and scans are spread out over days.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('country', django_countries.fields.CountryField(db_index=True,
                                                                 help_text='Part of the combination shown on the map.', max_length=2)),
                ...
                ('urls', models.PositiveIntegerField(default=0, help_text='Makes only sense on the total number of vulnerabilities')),
                ('endpoints', models.PositiveIntegerField(default=0,
                                                          help_text='Makes only sense on the total number of vulnerabilities')),
                ('organization_type', models.ForeignKey(help_text='Part of the combination shown on the map.',

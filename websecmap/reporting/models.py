...
class EndpointIssues(models.Model):
    ...
    endpoint_issues_low = models.IntegerField(
...
class UrlIssues(models.Model):
    ...
    total_url_issues = models.IntegerField(
        help_text="Total amount of issues on url level.",
        default=0
    )

    url_issues_high = models.IntegerField(
        help_text="Number of high issues on url level.",
        default=0
    )

    url_issues_medium = models.IntegerField(
        help_text="Number of medium issues on url level.",
        default=0
    )

    url_issues_low = models.IntegerField(
        help_text="Number of low issues on url level.",
        default=0
    )

    url_ok = models.IntegerField(
        help_text="Zero issues on these urls.",
        default=0
    )
...
class AllExplainedIssuesCombined(models.Model):
    ...
    explained_high = models.IntegerField(
    ...
    explained_low = models.IntegerField(
...
class ExplainedUrlIssues(models.Model):
    ...
    explained_url_issues_high = models.IntegerField(
        help_text="Total amount of issues on endpoint level.",
        default=0
    )
    ...
    explained_url_issues_low = models.IntegerField(
        help_text="Total amount of issues on endpoint level.",
        default=0
    )

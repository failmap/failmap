            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, default=0, help_text="A positive number of amount of credits received.", null=True
                    ),
                ),
                (
                    "credits_spent",
                    models.PositiveIntegerField(
                        blank=True, default=0, help_text="A positive number of the amount of credits spent.", null=True
                    ),
                ),
                (
                    "credit_mutation",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Description on how the mutation came to be. For example: deposit, scan on XYZ, etc. Be as complete as possible so it's obvious why credits where received and spent.",
                        max_length=1024,
                        null=True,
                    ),
                ),

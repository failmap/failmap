    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "endpoint",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="scanners.Endpoint"),
                ),
                (
                    "endpoint_scan",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="scanners.EndpointGenericScan"
                    ),
                ),
                (
                    "url",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="organizations.Url"),
                ),
                (
                    "url_scan",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="scanners.UrlGenericScan"
                    ),
                ),
            ],
        ),

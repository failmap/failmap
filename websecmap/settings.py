...
JET_SIDE_MENU_ITEMS = [  # A list of application or custom item dicts
    ...
    {'label': _('📄 Reports (generated)'), 'items': [
        {'name': 'reporting.organizationreport'},
        {'name': 'reporting.urlreport'},
        {'name': 'reporting.vulnerabilitystatistic'},
    ], 'permissions': ['admin']},
